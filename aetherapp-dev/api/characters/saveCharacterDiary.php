...
$input = aetherReadCharacterJsonRequest('saveCharacterDiary');
...
try {
    ...
    $canEditAchievementsOnly = !$canEditAll
        && aetherCanEditCharacterDiaryAchievements($currentUser, $character);
