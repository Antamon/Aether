...
try {
    ...
    aetherJsonResponse(['groups' => fetchAdminKnowledgeEventGossipGroups($pdo, (int) $input['idEvent'])]);
} catch (AetherValidationException $e) {
    aetherJsonValidationError($e->getValidationErrors());
} catch (Throwable $e) {
    error_log('getKnowledgeEventGossip.php failed: ' . $e->getMessage());
    aetherJsonError(500, 'Kon de wereldwijsgegevens van dit event niet laden.');
}
